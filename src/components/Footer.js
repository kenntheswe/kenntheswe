  ...
  return (
    <div className="flex justify-between items-center">
      <div className="flex space-x-3 ml-4 mb-4 text-3xl">
        ...
        <a href="https://github.com/Kenn-0" target="_blank" rel="noreferrer nofollow"><i className="devicon-github-original colored hover:opacity-70 transition-opacity duration-300"></i></a>
      </div>
