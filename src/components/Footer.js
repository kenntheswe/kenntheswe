  ...
  return (
    <div className="flex justify-between items-center my-3 mx-6">
      <div className="flex space-x-3 text-3xl">
        ...
        <a href="https://github.com/Kenn-0" target="_blank" rel="noreferrer nofollow"><i className="devicon-github-original colored hover:opacity-80 transition-opacity duration-300"></i></a>
      </div>
