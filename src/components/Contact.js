    ...
    return (
      <div className="m-8">
        <div className="flex justify-end space-x-3">
          <h1 className="text-2xl" id="contact">HIRE ME!</h1>
        ...
        <form className="flex flex-col justify-start contact mx-12 md:mx-24 lg:mx-36" onChange={sendEmail}> 
          ...
          <button data-aos="fade-up" className="focus:outline-none bg-green-400 hover:bg-green-300 transition-colors duration-500 px-6 py-2 mt-5 rounded-md self-center">Submit</button>
        </form>
      </div>
    )
  }
